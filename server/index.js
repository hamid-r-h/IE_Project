...
const getFavorites = require("./routes/user/getFavorites");
const getShops = require("./routes/user/getShops");
...
app.post(
  "/api/user/:shopid/product/:productid",
  authenticateToken,
  addExistingProduct
);
...
app.get("/api/user/shops", authenticateToken, getShops);
